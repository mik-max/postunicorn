...
const NODES: PlexusNode[] = [
  { cx:  100, cy:  80, r: 2.5, o: 0.13 },
  { cx:  240, cy:  40, r: 3.0, o: 0.16 },
  { cx:  380, cy: 160, r: 4.5, o: 0.28 },
  { cx:  180, cy: 300, r: 2.5, o: 0.13 },
  { cx:  480, cy:  70, r: 2.5, o: 0.13 },
  { cx:  560, cy: 240, r: 3.0, o: 0.16 },
  { cx:  680, cy: 120, r: 4.5, o: 0.30 },
  { cx:  740, cy: 340, r: 2.5, o: 0.13 },
  { cx:  860, cy: 200, r: 3.0, o: 0.16 },
  { cx:  940, cy:  60, r: 2.5, o: 0.13 },
  { cx: 1040, cy: 300, r: 4.5, o: 0.28 },
  { cx: 1140, cy: 160, r: 3.0, o: 0.16 },
  { cx: 1260, cy:  80, r: 2.5, o: 0.13 },
  { cx: 1340, cy: 260, r: 3.0, o: 0.15 },
  { cx: 1400, cy: 120, r: 2.5, o: 0.13 },
  { cx:   50, cy: 460, r: 2.5, o: 0.11 },
  { cx:  620, cy: 510, r: 2.5, o: 0.12 },
  { cx: 1100, cy: 550, r: 3.0, o: 0.14 },
];
...
const DOTS = [
  ...
  { cx:  440, cy: 420, r: 2.0 },
  { cx:  800, cy:  30, r: 1.5 },
  { cx: 1020, cy: 470, r: 2.0 },
  { cx: 1320, cy: 450, r: 1.5 },
];

const ctaTitleLines: Array<Array<{ text: string }>> = [
  [{ text: 'Thinking' }, { text: 'Worth' }],
  [{ text: 'Following.' }],
];
...
export default function InsightsCta() {
  ...
  useLayoutEffect(() => {
    ...
    const words    = h2Ref.current?.querySelectorAll<HTMLElement>('.ic-word') ?? [];
              ...
              {ctaTitleLines.map((line, lineIdx) => (
                <span key={lineIdx} className="block">
                  {line.map((word, wIdx) => (
                    ...
                    >
                      <span className="ic-word inline-block">{word.text}</span>
                    </span>
                  ))}
                </span>
              ))}
